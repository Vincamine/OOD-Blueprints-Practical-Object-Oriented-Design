 ...
 */
public class SwimmerAnother implements Comparable<SwimmerAnother> {
    private String name;
    ...
    public SwimmerAnother(String name, List<Double> butterfly50mTimes, List<Double> backstroke50mTimes,
    ...
    @Override
    //YOUR CODE HERE
    public int compareTo(SwimmerAnother otherSwimmer) {

        return this.calculateTotalNumberOfCompetingEvents(otherSwimmer);
    }
    private Integer calculateTotalNumberOfCompetingEvents(SwimmerAnother otherSwimmer){
        return otherSwimmer.getFreestyle50mTimes().size() + otherSwimmer.getBackstroke50mTimes().size() +
            otherSwimmer.getButterfly50mTimes().size() + otherSwimmer.getBreaststroke50mTimes().size();
    }
