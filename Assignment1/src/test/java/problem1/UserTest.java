...
class UserTest {
    ...
    @BeforeEach
    void setUp() {
        Credentials testCredentials = new Credentials("John Morse",
            "9691c818170472bad03dc1d3129c879f");
        User testUserWithInvalidPhoneNumber = new User("Krista Troy",
            "2da2af7d976ba89896165c94ffd297a0", "abc123", "troy@northeastern.edu",
            testCredentials);
        testUser = new User("Daniel", "Wade", "1234567890", "wade@northeastern.edu",
            testCredentials);
    }
