...
class LockerTest {
    ...
    void setUp() throws DimensionNumericException {
        ...
        testRecipient = new Recipient("Wyllie", "Wyllie", "fang.wenxu@northeastern.edu");
        testMailItem = new MailItem(10, 10, 12, testRecipient);
    }

    @Test
    void testLockerConstructor() {
        assertThrows(DimensionNumericException.class, () -> new Locker(0, 12, 18));
        assertThrows(DimensionNumericException.class, () -> new Locker(15, -1, 18));
        assertThrows(DimensionNumericException.class, () -> new Locker(15, 12, -2));
    }
    ...
    void getMailItem() throws DimensionNumericException {
        assertNull(testLocker.getMailItem());
    }
    ...
    void addMail_OccupiedLockerException() throws LargerThanLockerException, OccupiedLockerException {
        testLocker.addMail(testMailItem);
        assertThrows(OccupiedLockerException.class, () -> testLocker.addMail(testMailItem));
    }
    ...
    void addMail_LargerThanLockerException() throws DimensionNumericException {
        ...
        assertThrows(LargerThanLockerException.class, () -> testLocker.addMail(testMailItem1));
        MailItem testMailItem2 = new MailItem(10, 13, 10, testRecipient);
        assertThrows(LargerThanLockerException.class, () -> testLocker.addMail(testMailItem2));
        MailItem testMailItem3 = new MailItem(10, 10, 19, testRecipient);
        assertThrows(LargerThanLockerException.class, () -> testLocker.addMail(testMailItem3));
    }
    ...
    void pickupMail_EmptyLockerException() {
        assertThrows(EmptyLockerException.class, () -> testLocker.pickupMail(testRecipient));
    }

    @Test
    void pickupMail_RecipientNotMatchedException()
        throws LargerThanLockerException, OccupiedLockerException {
        Recipient newRecipient = new Recipient("James", "Bond", "12345@gmail.com");
        testLocker.addMail(testMailItem);
        assertThrows(RecipientNotMatchedException.class, () -> testLocker.pickupMail(newRecipient));
    }
}