        ...
        switch (eventType) {
            case LUNCH_TYPE:
                if (this.lunchEvent != null) {
                    ...
                    return new Schedule(new LunchEvent(clientName, numberOfPeople), this.dinnerEvent);
                }
            ...
            case DINNER_TYPE:
                if (this.dinnerEvent != null) {
                    ...
                    return new Schedule(this.lunchEvent, new DinnerEvent(clientName, numberOfPeople));
                }
